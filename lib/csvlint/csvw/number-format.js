...
/*
      if maxFractionDigits > 0
        if this.fractionalGroupingSize_ == 0
          fractional_regexp = ""
          fractional_regexp += "[0-9]{${minFractionDigits}}" if minFractionDigits > 0
          fractional_regexp += "[0-9]{0,${maxFractionDigits - minFractionDigits}}" unless minFractionDigits == maxFractionDigits
          fractional_regexp = "${escapeRegExp(this.decimalSeparator)}${fractional_regexp}"
          fractional_regexp = "(${fractional_regexp})?" if minFractionDigits == 0
          ...
          if minFractionDigits > 0
            if minFractionDigits >= this.fractionalGroupingSize_
              ...
              fractional_regexp += "[0-9]{${this.fractionalGroupingSize_}}"
              # additional groups of required digits - something like "(,[0-9]{3}){1}"
              fractional_regexp += "(${escapeRegExp(this.groupingSeparator_)}[0-9]{${this.fractionalGroupingSize_}}){${minFractionDigits / this.fractionalGroupingSize_ - 1}}" if minFractionDigits / this.fractionalGroupingSize_ > 1
              fractional_regexp += "${escapeRegExp(this.groupingSeparator_)}" if minFractionDigits % this.fractionalGroupingSize_ > 0
            end
            # additional required digits - something like ",[0-9]{1}"
            fractional_regexp += "[0-9]{${minFractionDigits % this.fractionalGroupingSize_}}" if minFractionDigits % this.fractionalGroupingSize_ > 0
            ...
            if opt_fractional_digits > 0
              ...
              if minFractionDigits % this.fractionalGroupingSize_ > 0
                ...
                fractional_regexp += "[0-9]{0,${[opt_fractional_digits, this.fractionalGroupingSize_ - (minFractionDigits % this.fractionalGroupingSize_)].min}}"
                fractional_regexp += "|"
                fractional_regexp += "[0-9]{${[opt_fractional_digits, this.fractionalGroupingSize_ - (minFractionDigits % this.fractionalGroupingSize_)].min}}"
              else
                fractional_regexp += "(${escapeRegExp(this.groupingSeparator_)}[0-9]{1,${this.fractionalGroupingSize_}})?"
                fractional_regexp += "|"
                fractional_regexp += "${escapeRegExp(this.groupingSeparator_)}[0-9]{${this.fractionalGroupingSize_}}"
              end
              ...
              if remaining_opt_fractional_digits > 0
                if remaining_opt_fractional_digits % this.fractionalGroupingSize_ > 0
                  ...
                  fractional_regexp += "(${escapeRegExp(this.groupingSeparator_)}[0-9]{${this.fractionalGroupingSize_}}){0,${remaining_opt_fractional_digits / this.fractionalGroupingSize_}}" if remaining_opt_fractional_digits > this.fractionalGroupingSize_
                  # remaining optional fraction digits
                  fractional_regexp += "(${escapeRegExp(this.groupingSeparator_)}[0-9]{1,${remaining_opt_fractional_digits % this.fractionalGroupingSize_}})?"
                else
                  # optional fraction digits in groups
                  fractional_regexp += "(${escapeRegExp(this.groupingSeparator_)}[0-9]{${this.fractionalGroupingSize_}}){0,${(remaining_opt_fractional_digits / this.fractionalGroupingSize_) - 1}}" if remaining_opt_fractional_digits > this.fractionalGroupingSize_
                  # remaining optional fraction digits
                  fractional_regexp += "(${escapeRegExp(this.groupingSeparator_)}[0-9]{1,${this.fractionalGroupingSize_}})?"
                end
                ...
                fractional_regexp += "(${escapeRegExp(this.groupingSeparator_)}[0-9]{${this.fractionalGroupingSize_}}){0,${(remaining_opt_fractional_digits / this.fractionalGroupingSize_) - 1}}" if remaining_opt_fractional_digits > this.fractionalGroupingSize_
                # remaining optional fraction digits
                fractional_regexp += "(${escapeRegExp(this.groupingSeparator_)}[0-9]{1,${remaining_opt_fractional_digits % this.fractionalGroupingSize_}})?" if remaining_opt_fractional_digits % this.fractionalGroupingSize_ > 0
              end
              fractional_regexp += ")"
            end
          elsif maxFractionDigits % this.fractionalGroupingSize_ > 0
            # optional fractional digits in groups
            fractional_regexp += "([0-9]{${this.fractionalGroupingSize_}}${escapeRegExp(this.groupingSeparator_)}){0,${maxFractionDigits / this.fractionalGroupingSize_}}"
            # remaining optional fraction digits
            fractional_regexp += "(${escapeRegExp(this.groupingSeparator_)}[0-9]{1,${maxFractionDigits % this.fractionalGroupingSize_}})?" if maxFractionDigits % this.fractionalGroupingSize_ > 0
          else
            fractional_regexp += "([0-9]{${this.fractionalGroupingSize_}}${escapeRegExp(this.groupingSeparator_)}){0,${(maxFractionDigits / this.fractionalGroupingSize_) - 1}}" if maxFractionDigits > this.fractionalGroupingSize_
            fractional_regexp += "[0-9]{1,${this.fractionalGroupingSize_}}"
          end
          fractional_regexp = "${escapeRegExp(this.decimalSeparator)}${fractional_regexp}"
          fractional_regexp = "(${fractional_regexp})?" if minFractionDigits == 0
          numericPartRegExp += fractional_regexp
